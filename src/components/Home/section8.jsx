...
const Section8 = () => {
    return (
        <div className="px-[50px] mt-[50px] ">
            <div  className="bg-[#C2FF66] py-[50px] rounded-lg flex flex-col justify-center items-center">
                ...
                <div className="h-[58px] mt-[20px] flex flex-row justify-center items-center rounded-full px-[10px] space-x-[10px] bg-[#EAFFCC]">
                    <div className="text-[14px] w-[460px] text-black grow outline-none bg-transparent font-semibold cursor-default">Click here to donate now and help level up the lives of children in need</div>
