...
const Section8 = () => {
    return (
        <div className="px-[20px] lg:px-[50px] mt-[50px] ">
            <div  className="bg-[#F7941D] py-[50px] rounded-lg flex flex-col justify-center items-center px-[10px]">
                ...
                <div className="h-[58px] mt-[20px] flex flex-row justify-center items-center rounded-full px-[10px] gap-x-[10px] bg-[#FFD4A1] md:w-full">
                    <div className="hidden md:block text-[14px] w-[520px] text-black grow outline-none bg-transparent font-semibold cursor-default">Click here to donate now and help level up the lives of children in need</div>
                    <div className='flex flex-row justify-center items-center gap-[4px] rounded-full px-[13px] py-[10px] bg-[#F7941D] cursor-pointer'>
                        <p className='text-[13px] font-[500] text-nowrap'>Donate Now</p>
