  ...
  return (
    <div className="px-[0] md:px-[20px] lg:px-[50px] mt-[70px]">
      <div className="flex flex-col justify-center items-center">
        <div className="bg-[#FFD4A1] border-[#fbfcfa] rounded-lg border-[5px] h-[200px] md:h-[300px] lg:h-[400px] w-full"><img src={ ourvision } className="w-full h-full object-cover"/></div>
      ...
      <div className="flex flex-col md:flex-row justify-center bg-[#fbfcfa] p-[30px] rounded-lg mt-[30px] gap-x-[30px] gap-y-[20px]">
        <div className="flex flex-col justify-start w-full md:w-[50%] bg-white rounded-lg p-[20px] gap-[7px]">
          ...
          <p className="text-[13px]">
            We see a future where every young Nigerian is empowered to dream BIG
            and innovate towards a self-reliant nation.
          </p>
        </div>
        <div className="flex flex-col justify-start w-full md:w-[50%] bg-white rounded-lg p-[20px] gap-[7px]">
          <div className="flex flex-row justify-between items-center ">
          ...
          <p className="text-[13px]">
            We aim to be the catalyst for transforming Nigeria's youth into
            globally competitive leaders & skilled professionals.
          </p>
        </div>
      </div>
    </div>
