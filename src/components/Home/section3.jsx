    ...
    return (
        <div className="mt-[50px]">
            <div className="text-center flex flex-col justify-center items-center gap-[10px]">
                <p className="text-[28px] font-semibold">Turning Small wins, into BIG Ones!</p>
                <p className="text-[13px]">We are recognizing & celebrating academic & vocational achievements at a small level, to inspire the next BIG thing. </p>
                <p className="text-[13px] font-medium rounded-lg md:rounded-full px-[10px] py-[10px] bg-[#E9E9E9] mt-[20px]">Our foundation believes in the depth of human potential. We can unlock at with just enough encouragement.</p>
            </div>
                ...
                <div className="w-full md:w-[60%] bg-[#E9E9E9] p-[30px] rounded-lg flex flex-col justify-center gap-y-[30px] h-full">
                    ...
                    <div className="flex flex-col justify-center items-center bg-white rounded-lg p-[20px]">
                        ...
                        <div className="flex flex-row gap-[10px] justify-normal items-center border-b-[2px] pt-[15px] pb-[20px]">
                            ...
                            <p className="text-[13px]">More vocational shill development & entrepreneurship.</p>
                        </div>
                        <div className="flex flex-row gap-[10px] justify-normal items-center border-b-[2px] pt-[15px] pb-[20px]">
                            ...
                            <p className="text-[13px]">Foster a culture of academic a vocational excellence.</p>
                        </div>
                        <div className="flex flex-row gap-[10px] justify-normal items-center pt-[15px]">
                            ...
                            <p className="text-[13px]">Build strong partnership with communities, schools 2 businesses to support youth development initiatives.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div className="flex flex-row-reverse justify-center items-center px-[20px] lg:px-[50px] gap-[30px] mt-[30px] md:h-[660px] lg:h-[520px]">
                <div className="hidden md:block md:w-[45%] lg:w-[40%] bg-[#FFD4A1] rounded-lg border-[5px] h-full"></div>
                <div className="w-full md:w-[60%] bg-[#E9E9E9] p-[30px] rounded-lg flex flex-col justify-center space-y-[30px] h-full">
                    ...
                    <div className="flex flex-col justify-center items-center bg-white rounded-lg p-[20px]">
                        ...
                        <div className="flex flex-row gap-[10px] justify-normal items-center border-b-[2px] pt-[15px] pb-[20px]">
                            <div className="h-[40px] w-[40px] bg-[#F7941D] rounded-full text-[20px] font-semibold flex justify-center items-center shrink-0">02</div>
                            <p className="text-[13px]">Partner with local businesses to secure Intersi ship 2 apprenticeship opportunities for at least 50 train each year.</p>
                        </div>
                        <div className="flex flex-row gap-[10px] justify-normal items-center border-b-[2px] pt-[15px] pb-[20px]">
                            <div className="h-[40px] w-[40px] bg-[#F7941D] rounded-full text-[20px] font-semibold flex justify-center items-center shrink-0">03</div>
                            <p className="text-[13px]">Establish annual awards ceremony to recognize top-performing students and trainees in both academic & Vocational fields.</p>
                        </div>
                        <div className="flex flex-row gap-[10px] justify-normal items-center pt-[15px]">
                            <div className="h-[40px] w-[40px] bg-[#F7941D] rounded-full text-[20px] font-semibold flex justify-center items-center shrink-0">04</div>
                            <p className="text-[13px]">Introduce life shills 2L leadership training modules into all educational & Vocational programs.</p>
                        </div>
                    </div>
                </div>
            </div>
