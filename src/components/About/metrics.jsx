    ...
    return (
        <div className="mt-[100px] md:mt-[180px] lg:mt-[80px]">
            ...
            <div className="flex flex-col md:flex-row justify-center mt-[30px] gap-[20px]">
                <div className="flex flex-col gap-[20px] md:gap-[10px] p-[20px] w-full md:w-[30%] bg-[#d0e3ff] rounded-[25px] items-center">
                ...
                <div className="flex flex-col gap-[20px] md:gap-[10px] p-[20px] w-full md:w-[30%] bg-[#ffd7e3] rounded-[25px] items-center">
                ...
                <div className="flex flex-col gap-[20px] md:gap-[10px] p-[20px] w-full md:w-[30%] bg-[#ead8fc] rounded-[25px] items-center">
