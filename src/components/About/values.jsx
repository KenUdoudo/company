            ...
            <div className="flex flex-col flex-wrap md:flex-row justify-between mt-[70px] gap-y-[20px] md:gap-y-[50px]">
                <div className="flex flex-col w-full md:w-[45%]">
                    <div className="flex items-center gap-[30px]">
                        <FaThumbsUp className="p-[25px] bg-[#d0e3ff] rounded-md"/>
                ...
                <div className="flex flex-col w-full md:w-[45%]">
                    <div className="flex items-center gap-[30px]">
                        <GiStumpRegrowth className="p-[25px] bg-[#ffd7e3] rounded-md"/>
                ...
                <div className="flex flex-col w-full md:w-[45%]">
                    <div className="flex items-center gap-[30px]">
                        <IoMdBuild className="p-[25px] bg-[#ead8fc] rounded-md"/>
                ...
                <div className="flex flex-col w-full md:w-[45%]">
                    <div className="flex items-center gap-[30px]">
                        <TbHeartHandshake className="p-[25px] bg-[#e7f8c7] rounded-md"/>
                ...
                <div className="flex flex-col w-full md:w-[45%]">
                    <div className="flex items-center gap-[30px]">
                        <HiSparkles className="p-[25px] bg-[#d0e3ff] rounded-md"/>
